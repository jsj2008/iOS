...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (newsForNow.published)
		cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", [self.dateFormatter stringFromDate:newsForNow.published]];
	else
		cell.detailTextLabel.text = newsForNow.pubDate;
