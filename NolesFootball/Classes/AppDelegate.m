...
- (void)addTabViewControllertoWindow;
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
		[self addTabViewControllertoWindow];
	else {
...
- (void)addTabViewControllertoWindow {
	if (![Utilities isNetworkAvailable])
		[Utilities showAlertView:@"Network Problem" message:@"Sorry, NolesFootball needs to be connected to the internet. Please try again when you have better coverage"];
	else
